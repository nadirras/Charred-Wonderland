...
export default function BookPreview() {
  return (
    <section id="book_preview" className="py-20 bg-base-200 dark:bg-neutral-900">
      <div className="max-w-6xl mx-auto px-4">
        {/* Header */}
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-serif font-semibold text-neutral-800 dark:text-neutral-100 mb-3">✦ Book Preview ✦</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {books.map((book, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="card bg-base-100 dark:bg-neutral-800 shadow-xl hover:shadow-2xl duration-300 rounded-2xl overflow-hidden"
            >
              <div className="relative w-full h-80">
                <Image src={book.cover} alt={book.title} fill className="object-cover" />
              </div>
              <div className="card-body p-6">
                <h3 className="text-xl font-serif font-semibold text-neutral-800 dark:text-neutral-100">{book.title}</h3>
                <p className="text-neutral-600 dark:text-neutral-400 text-sm">{book.blurb}</p>
